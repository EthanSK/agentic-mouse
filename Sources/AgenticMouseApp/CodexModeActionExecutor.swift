    ...
    func perform(
        ...
        case .addToChat:
            result = .failure(ActionError(
                description: "Add to chat must use the VS Code command bridge"
            )) // Add to chat targets VS Code's command API, never Codex's keyboard or Accessibility transport. (Codex task: 01a068dc-c698-7312-bc0b-6221c39286e4)
        case .pressEnter:
