...
Cell 8 release stores a one-second source-specific expiry, and the VS Code layer turns one
same-source cell-7 press during that window into F18 Stage + Next instead of Enter.
