...
const LAYERS = {
  ...
  vscodeBase: {
    ...
    actions: [
      ...
      ["Enter · 1s guard after 8", "Press normally for Enter, press while holding button 8 to stage and advance, or release button 8 first to suppress Enter for one second."],
      ["Next Change · Hold + Enter to Stage", "Release for Better Git Next Change and start the one-second Enter guard, or hold while pressing the same mouse's Enter button to stage and advance."],
