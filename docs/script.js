...
const LAYERS = {
  default: {
    ...
    actions: [
      ...
      ["YouTube · Hold 2× / Scrub + Wheel", "Click to rewind five seconds. Hold for temporary 2× speed, restoring the prior speed without seeking on release. Wheel input cancels the boost and scrubs by five seconds."],
  ...
  vscodeBase: {
    ...
    actions: [
      ...
      ["Copy / Paste · Stage + Previous after 5", "Hold and ratchet normally, or stage and move backward while holding button 5 and for one second after it releases."],
      ["Previous Change · Hold + 4 to Stage", "Release sends Better Git Previous Change immediately; hold it and press button 4 for Stage + Previous."],
      ["YouTube · Hold 2× / Scrub + Wheel", "Inherited from Default."],
      ["Enter · Stage + Next after 8", "Press normally for Enter, or stage and advance while holding button 8 and for one second after it releases."],
      ["Next Change · Enter stages for +1s", "Release for Better Git Next Change; the same mouse's Enter button stages and advances while held and for one second after release."],
  ...
  chrome: {
    ...
    actions: [
      ...
      ["Open website", "Open the fixed Chrome websites submenu."],
  ...
  chromeWebsites: {
    label: "Chrome websites",
    actions: [
      ["YouTube", "Open YouTube directly to the right of Chrome's active tab."],
      ["Exit Chrome mode", "Return directly to Default."],
      ["X", "Open X directly to the right of Chrome's active tab."],
      ["Facebook", "Open Facebook directly to the right of Chrome's active tab."],
      ["GitHub", "Open Ethan's GitHub directly to the right of Chrome's active tab."],
      ["LinkedIn", "Open LinkedIn directly to the right of Chrome's active tab."],
      ["Gemini", "Open Gemini directly to the right of Chrome's active tab."],
      ["Back to Chrome", "Return to the Chrome action page."],
      ["Grok", "Open Grok directly to the right of Chrome's active tab."],
      ["Exit Chrome mode", "Return directly to Default."],
      SPARE,
      SPARE,
    ],
